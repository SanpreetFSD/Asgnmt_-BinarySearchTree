...
linkedList.insert(1, "Mohan", "12/03/2021", 2000);
linkedList.insert(2, "Chandan", "01/07/2018", 5000);
linkedList.insert(3, "Ram", "31/01/2003", 3400);
linkedList.insert(4, "Murli", "16/10/2012", 9860);
linkedList.insert(4, "Gopal", "16/10/2012", 1258);

console.log("\n\nAll customer data sorted by bill amount:");
linkedList.display();
linkedList.findByName("Chandan");
